repeat task.wait() until game:IsLoaded() do
	Debug = false
	BETA = false
...
do
	...
	Add_Command("addnuke",function(Args)
		...
		if Player then
			game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("dont kill" ..Player.Name.. , "ALL")
			repeat task.wait()
			...
			until not game
			game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(Player.Name.." is dead....", "ALL")
			wait(1.5)
			...
			wait(1.5)
			game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FreServer("LAUNCHING IN 2", "I")			
			wait(1.5)
			game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("LAUNCHING IN 1", "E")
			wait(2)
			Kill_All()
